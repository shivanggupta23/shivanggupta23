...
class K6Screen extends StatefulWidget {
  ...
  @override
  K6ScreenState createState() => K6ScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => K6Provider(),
      child: K6Screen(),
    );
  }
}

class K6ScreenState extends State<K6Screen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildName(BuildContext context) {
    return Selector<K6Provider, TextEditingController?>(
      selector: (
        context,
        provider,
      ) =>
